...
#define log(format, ...) { \
    printf("%llu | %llu | ", std::chrono::duration_cast<std::chrono::seconds>(std::chrono::steady_clock::now().time_since_epoch()).count(), std::this_thread::get_id());  \
...
////        log("%s\n", __PRETTY_FUNCTION__);
//        result_ = add100(init_);
//        handle.resume();
////        auto f = [handle, this](int value) mutable {
//////            log("value=%d\n", value);
////            result_ = value;
////            log("Before call resume\n");
////            handle.resume();
////            log("After call resume\n");
////        };
...
//Task add(int base) {
//    log("co_await");
//    int ret = co_await Add(base);
//    log("ret=%d", ret);
//    log("co_await");
//    ret = co_await Add(ret);
//    log("ret=%d", ret);
//    log("co_await");
//    ret = co_await Add(ret);
//    log("ret=%d", ret);
...
//
//int main() {
////    auto f = [](int value) { log("get result from coroutine: %d\n", value); };
//    log("call add");
//    add(10);
//    log("call add");
//    add(20);
